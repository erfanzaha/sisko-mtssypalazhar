...
<script type="text/javascript">
	...
	new GridBuilder( _grid , {
		...
		can_add: false,
		resize_column: 5,
		extra_buttons: '<a class="btn btn-sm btn-default add" href="' + _BASE_URL + 'blog/posts/create'+'" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-plus"></i></a>'
	});
