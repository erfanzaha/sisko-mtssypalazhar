...
new FormBuilder( _form , {
   controller:'academic/academic_years',
   fields: [
      { label:'Tahun Pelajaran', name:'academic_year', placeholder:'Separated by (-). Example: 2016-2017' },
      ...
      { label:'PPDB Aktif?', name:'admission_semester', type:'select', datasource:DS.TrueFalse }
   ]
});
</script>
