...
<section class="content">
	<div class="callout">
		...
		<ol>
			...
			<li>Isikan data dengan urutan <strong>[NIS] [NAMA LENGKAP] [TANGGAL LAHIR] [JENIS KELAMIN] [TANGGAL MASUK] [TANGGAL KELUAR] [HANDPHONE] [ALAMAT JALAN]</strong></li>
			...
			<li>Kolom <strong>TANGGAL LAHIR</strong>, <strong>TANGGAL MASUK</strong> dan <strong>TANGGAL KELUAR</strong> diisi dengan format <strong>YYYY-MM-DD</strong>.</li>
		</ol>
	</div>
	<div class="box">
		<div class="box-body">
