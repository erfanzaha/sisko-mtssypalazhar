...
<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="card h-100 border border-secondary rounded-0">
					<div class="row no-gutters">
						<div class="col-md-4">
							...
							echo "<img src='". base_url('media_library/users/photo/' . $photo) . "' class='card-img rounded-0 img-fluid p-2'>";
							?>
						</div>
						<div class="col-md-8">
							<div class="card-body pt-2 pb-2">
								<dl class="row">
									...
									<dd class="col-sm-7"><?=substr($row->nis, 0, 4)?>*******</dd>
									...
									<dd class="col-sm-7"><?=$row->year_in?></dd>

									<dt class="col-sm-5">Tahun Keluar</dt>
									<dd class="col-sm-7"><?=$row->year_out?></dd>
								</dl>
							</div>
						</div>
					</div>
	...
	<div class="justify-content-between align-items-center float-right mb-3 w-100 more-alumni">
		<button type="button" onclick="get_alumni()" class="btn btn-success rounded-0 float-right"><i class="fa fa-refresh"></i> Tampilkan Lebih Banyak</button>
	</div>
</div>
