	...
	if ( page <= parseInt(total_page) ) {
		...
		$.post( _BASE_URL + 'public/employee_directory/get_employees', data, function( response ) {
			...
			for (var z in rows) {
				...
				str += '<dd class="col-sm-7">' + (row.nik).substring(0, 4) + '*******</dd>';
...
<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-md-8">
							<div class="card-body pt-2 pb-2">
								<dl class="row">
									...
									<dd class="col-sm-7"><?=substr($row->nik, 0, 4)?>*******</dd>
	...
	<div class="justify-content-between align-items-center float-right mb-3 w-100 more-employees">
		<button type="button" onclick="get_employees()" class="btn btn-success rounded-0 float-right"><i class="fa fa-refresh"></i> Tampilkan Lebih Banyak</button>
	</div>
</div>
