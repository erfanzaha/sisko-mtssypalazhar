...
<head>
	...
	<?=link_tag('views/themes/4/style.css')?>
					...
					<?php if (__session('admission')['admission_status'] == 'open') { ?>
						<div class="col widget-box-3 d-flex p-4 align-items-stretch">
							<div class="d-flex flex-column mb-3">
								...
								<div class="bd-highlight">
									<a class="btn btn-sm btn-info btn-block font-weight-bold" href="<?=site_url('formulir-penerimaan-peserta-didik-baru')?>">DAFTAR SEKARANG</a>
								</div>
							</div>
						</div>
					<?php } ?>
