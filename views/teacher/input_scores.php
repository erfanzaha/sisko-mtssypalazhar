	...
	*/
	function is_exists() {
		...
		if (values['course_class_id']) {
			...
			$.post(_BASE_URL + 'teacher/input_scores/is_exists', values, function( response ) {
				_H.Loading( false );
	...
	function _insert_class_meetings() {
		...
		if (values['course_class_id']) {
			_H.Loading( true );
			$.post(_BASE_URL + 'teacher/input_scores/insert', values, function( response ) {
				_H.Loading( false );
				var res = _H.StrToObject( response );
	...
	function _print_meeting_attendance() {
			...
			window.open(_BASE_URL + 'teacher/input_scores/print_students_scores/' + course_class_id, '_blank');
