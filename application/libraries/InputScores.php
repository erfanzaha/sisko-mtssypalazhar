...
class InputScores extends TCPDF {
	...
	public function pdf(array $params = []) {
		...
		$str = file_get_contents(VIEWPATH . 'pdf_templates/grade_template.html');
		$str = str_replace('[LOGO]', base_url('media_library/images/94c6b60bee445f8e785d130eea675e84.png'), $str);
		...
		foreach($params['students'] as $row) {
			...
			$students .= '<td width="15%" align="center">' . $row['nis'] . '</td>';
			$students .= '<td width="38%" align="left"> ' . $row['full_name'] . '</td>';
			$students .= '<td width="10%" align="center">' . $row['gender'] . '</td>';
			$students .= '<td width="10%" align="center">' . $row['assignment_score'] . '</td>';
			$students .= '<td width="10%" align="center">' . $row['mid_score'] . '</td>';
			$students .= '<td width="10%" align="center">' . $row['exam_score'] . '</td>';
