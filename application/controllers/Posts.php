...
class Posts extends Admin_Controller {
	...
	private function image_resize($path, $file_name) {
		...
		$thumb['width'] = (int) __session('writing')['post_image_thumbnail_width'];
		$thumb['height'] = (int) __session('writing')['post_image_thumbnail_height'];
		...
		$medium['width'] = (int) __session('writing')['post_image_medium_width'];
		$medium['height'] = (int) __session('writing')['post_image_medium_height'];
		...
		$large['width'] = (int) __session('writing')['post_image_large_width'];
		$large['height'] = (int) __session('writing')['post_image_large_height'];
