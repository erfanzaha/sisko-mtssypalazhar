...
class Employment_types extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['employees'] = $this->vars['employment_types'] = TRUE;
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'employment_type', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'employment_type');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Jenis Guru dan Tenaga Kependidikan', 'trim|required');
