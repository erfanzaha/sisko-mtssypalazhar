...
class Subject_national_exam_settings extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_admission_subject_settings->get_where($keyword, 'national_exam', 'rows', $limit, $offset);
			$total_rows = $this->m_admission_subject_settings->get_where($keyword, 'national_exam');
