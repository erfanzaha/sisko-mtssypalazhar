...
class Semester_report_scores extends Admin_Controller {
	...
	public function get_prospective_students() {
		if ($this->input->is_ajax_request()) {
			...
			// Get Prospective Students
			$query = $this->m_admission_subject_scores->get_subject_scores($admission_year_id, $admission_type_id, $major_id, 'semester_report', 'rows', $limit, $offset);
			$total_rows = $this->m_admission_subject_scores->get_subject_scores($admission_year_id, $admission_type_id, $major_id, 'semester_report');
