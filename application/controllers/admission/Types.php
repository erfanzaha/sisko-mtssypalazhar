...
class Types extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'admission_type', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'admission_type');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Jenis Pendaftaran', 'trim|required');
