...
class Archives extends Public_Controller {
	...
	public function index() {
		...
		if ($year && $month) {
			...
			$this->vars['query'] = $this->m_posts->get_post_archives($year, $month, __session('reading')['post_per_page']);
	...
	public function get_posts() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_posts->get_post_archives($year, $month, __session('reading')['post_per_page'], $offset);
