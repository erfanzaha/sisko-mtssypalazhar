...
class Tampil_nilai extends Admin_Controller {
	...
	public function print_students_scores() {
		...
		if ( _isNaturalNumber( $course_class_id )) {
			...
			$this->load->library('input_scores');
			$this->input_scores->pdf($params);
		}
	}
}
