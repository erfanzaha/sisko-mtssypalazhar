...
class Student_score extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['student_score'] = TRUE;
		$this->vars['content'] = 'student_score';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_grade->student_grade_report($keyword, 'rows', $limit, $offset);
			$total_rows = $this->m_grade->student_grade_report($keyword);
