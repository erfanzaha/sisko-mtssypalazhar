...
class Employments extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['reference'] = $this->vars['employments'] = TRUE;
		$this->vars['content'] = 'reference/employments';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'employment', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'employment');
