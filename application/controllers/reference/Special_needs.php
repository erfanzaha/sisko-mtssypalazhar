...
class Special_needs extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'special_need', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'special_need');
