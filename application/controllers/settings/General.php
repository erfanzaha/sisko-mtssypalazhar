...
class General extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['timezone_list'] = json_encode(timezone_list(), self::REQUIRED_FLAGS);
			...
			if (_isNaturalNumber( $id )) {
				...
				if (!$this->upload->do_upload('file')) {
					...
					if ($update) {
						...
						// resize new image
						$this->image_resize(FCPATH.'media_library/images', $upload['file_name'], $query->setting_variable);
					}
