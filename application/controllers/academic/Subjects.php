...
class Subjects extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_subjects->get_where($keyword, 'rows', $limit, $offset);
			$total_rows = $this->m_subjects->get_where($keyword);
