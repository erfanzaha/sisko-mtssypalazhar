...
class Transportations extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'transportation', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'transportation');
