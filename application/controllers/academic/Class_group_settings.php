...
class Class_group_settings extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Wali Kelas';
		...
		$this->vars['class_group_dropdown'] = json_encode($this->m_class_groups->dropdown(), self::REQUIRED_FLAGS);
		$this->vars['employee_dropdown'] = json_encode($this->m_employees->dropdown(), self::REQUIRED_FLAGS);
