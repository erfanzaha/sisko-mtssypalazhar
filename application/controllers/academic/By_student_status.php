...
class By_student_status extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'GRAFIK PESERTA DIDIK BERDASARKAN STATUS PESERTA DIDIK';
	...
	public function generate_chart() {
		if ($this->input->is_ajax_request()) {
			...
			$this->vars['title'] = 'GRAFIK PESERTA DIDIK BERDASARKAN STATUS PESERTA DIDIK TAHUN PELAJARAN';
			$this->vars['labels'] = [];
			$this->vars['data'] = [];
