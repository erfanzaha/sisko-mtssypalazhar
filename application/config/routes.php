...
$route['pdf-formulir-penerimaan-peserta-didik-baru/[0-9]/([0-9]{4})-([0-9]{2})-([0-9]{2})/([0-9]{9})'] = 'public/admission_form/print_admission_form';
$route['cetak-kartu-peserta-ujian-seleksi-penerimaan-peserta-didik-baru'] = 'public/print_admission_exam_card';
